...
namespace sqlite3x {
	...
	class _declspec(dllexport) sqlite3_connection{
	private:
	...
	public:
		...
		void executegettable(
                       const char *sql,    /* SQL to be evaluated */
                       char ***pazResult, /* Write the result table here */
                       int *pnRow,         /* Write the number of rows in the result here */
                       int *pnColumn);      /* Write the number of columns of result here */
  
		void freegottable(char **result);

	};

	//class sqlite3_transaction : boost::noncopyable {
	class _declspec(dllexport) sqlite3_transaction{
	private:
	...
	class _declspec(dllexport) sqlite3_command  {
	private:
	...
	class _declspec(dllexport) sqlite3_reader {
	private:
		friend class sqlite3_command;
