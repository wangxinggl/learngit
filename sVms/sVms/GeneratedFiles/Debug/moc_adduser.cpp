...
QT_MOC_LITERAL(3, 17, 16), // "on_btnOk_clicked"
QT_MOC_LITERAL(4, 34, 20), // "on_btnCancel_clicked"
QT_MOC_LITERAL(5, 55, 19) // "on_btnClose_clicked"

    },
    "addUser\0sendMsg\0\0on_btnOk_clicked\0"
...
void addUser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendMsg((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        {
            typedef void (addUser::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&addUser::sendMsg)) {
                *result = 0;
                return;
            }
        }
