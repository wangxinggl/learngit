...
QT_MOC_LITERAL(1, 9, 12), // "clickedEvent"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "OneVideo\0clickedEvent\0"
};
...
void OneVideo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OneVideo::clickedEvent)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject OneVideo::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_OneVideo.data,
      qt_meta_data_OneVideo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
