...
public:
	...
	bool flag;
	TreeData_t *m_pChannelInfo;
	map<int, TreeData_t*> m_mapChannelTmp;
	int nCheckNum;
	long lChannel;
	long m_nRecordtype;
	...
	map<int, vector<VIDEONET_FILE_DATA>> m_videoFile;
	map<int, VideoTimeLine*> m_mapVideoLine;

	void ShowPicture(QString& strPath);
	void cleaLayout();
...
private:
	...
	TreeData_t* pFindFileInfo;
	 ...
	 VideoTimeLine* m_videoTimeLine_tmp;
	 QList<VideoTimeLine *> videoTimeLineList;
